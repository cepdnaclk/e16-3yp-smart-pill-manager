...
exports.emailSender = (deviceID, email) => {
  const client_id =
  ...
  const CLIENT_URL = "http://localhost:3900";

  const output = `
  <h2>Forgot your password?</h2>
  <p>That's okay...you can create your new password here.</p><br>
  <p>Click the link below.</p>
  <p>${CLIENT_URL}/api/changepassword/${token}</p>
  `;
  ...
  const mailOptions = {
    ...
    subject: "SmartPillManager: Reset your password", // Subject line
